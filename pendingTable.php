...
<h2 id="title">
    ...
    <span>
        ...
        <!-- <button class="btn blotter" onclick="window.location.href='#'">
            <i class="fa-solid fa-file"></i> Permit
        </button> -->
...
<div class="table-container">
    <table class="table table-hover table-bordered borderColor">
        <thead>
            <tr>
                <th>#</th>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="oneLine">
                                <li><a class="dropdown-item edit-button" name="update" href="updatePending.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit"></i></a></li>
                                <!-- <a class="dropdown-item edit-button" name="update" href="updatePending.php"><i class="fas fa-edit"></i></a> -->
